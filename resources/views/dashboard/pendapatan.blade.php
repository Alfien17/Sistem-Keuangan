@extends('main')
@section('judul_halaman','Pendapatan')
@section('konten')
    <br>
    <div class="container">
        <form method="post" action="/postpendapatan" enctype="multipart/form-data" class="pb-2">
            {{ csrf_field() }}
                    ...
                    <table id="example" class="table table-striped table-hover display nowrap" cellspacing="0" width="100%">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>Rp. {{number_format((float)$total*-1)}}</th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
