@extends('main')
@section('judul_halaman','Pilih Tanggal Neraca Saldo')
@section('konten')
<br>
<div class="container">
	<form method="post" action="/main/laporan-neracasaldo/view" enctype="multipart/form-data">
	{{ csrf_field() }}
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-7 text-right">
                    <a type="button" class="btn btn-outline-custom" href="/main/laporan-neracasaldo">Cancel</a>
