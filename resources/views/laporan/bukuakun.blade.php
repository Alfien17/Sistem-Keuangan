@extends('main')
@section('konten')
<h4 class="container">{{$kode->kd_akun}} | {{ucwords($kode->nama_akun)}} </h4>
...
<div class="container">
    ...
    <ol class="breadcrumb bg-transparent">
        ...
        <li class="breadcrumb-item text-black"><a class="text-dark" href="/main/laporan-akun">Pilih-akun</a></li>
                            ...
                            <td>
                                @foreach ($saldo as $s)
                                    @if ($s->id == $d->id)
                                        ...
                                        @else
                                            Rp. {{number_format((float)$s->saldo*-1)}}
                                        @endif
                                    @endif
                            @endforeach
                            </td>
                ...
                buttons: [
                    {
                        ...
                        extend: 'excel',
                        title: 'Rekap Akun {{$kode->kd_akun}} {{$month2}} {{$year2}}',
                        messageTop: 'Nama Akun : {{ucwords($kode->nama_akun)}}          Kode Akun : {{$kode->kd_akun}}',
                    },
                    {
