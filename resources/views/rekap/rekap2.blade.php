    ...
    <div class="d-flex justify-content-between">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <li><a class="toggle-vis dropdown-item cursor" data-column="2">Buku Kas</a></li>
                <li><a class="toggle-vis dropdown-item cursor" data-column="3">Cash/Cashless</a></li>
                <li><a class="toggle-vis dropdown-item cursor" data-column="4">Kategori</a></li>
                <li><a class="toggle-vis dropdown-item cursor" data-column="5">Debit</a></li>
                <li><a class="toggle-vis dropdown-item cursor" data-column="6">Kredit</a></li>
                <li><a class="toggle-vis dropdown-item cursor" data-column="7">Rp.</a></li>
            </ul>
        </div>
    </div>
                ...
                <table id="example" class="table table-striped table-hover display nowrap" cellspacing="0" width="100%">
                    <thead class="table-control text-center">
                        <tr>
                            <th>#</th>
                            <th>Tanggal</th>
                            <th data-priority="1">Buku Kas</th>
                            <th>Cash/Cashless</th>
                            <th>Kategori</th>
                            <th>Debit</th>
                            <th>Kredit</th>
                            <th data-priority="3">Rp.</th>
                        ...
                        @if ($k->status == 'debit')
                            <tr>
                                ...
                                @foreach($keuangan as $keu)
                                    @if ($keu->kode == $k->kode)
                                        @if ($keu->status == 'kredit')
                                            <td title="{{ucwords($keu->akun->nama_akun)}}" style="cursor: pointer">{{$keu->akun->kd_akun}}</td>
                                        @endif
                                    @endif
                                @endforeach
